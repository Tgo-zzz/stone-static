...
if (window.client) {
  ...
  document.getElementById("user")?document.getElementById("user").href = "#":null;
  document.getElementById("user")?document.getElementById("user").addEventListener("click", function () {
...
if(login){
  login.addEventListener("click",function(){
    console.log("登陆地址")
    document.getElementById("entry").href = "../userEntry/login.html"
    document.getElementById("entry").style.visibility = "visible"
  })
}
if(reg){
  reg.addEventListener("click",function(){
    console.log("注册地址")
    document.getElementById("entry").href = "../userEntry/register.html"
    document.getElementById("entry").style.visibility = "visible"
  })
}
